package br.gov.ce.sps.oisol.api.exceptionhandler;

import br.gov.ce.sps.oisol.domain.exception.*;
import br.gov.ce.sps.oisol.infrastructure.service.storage.StorageException;
