...
public @interface CheckSecurity {
	...
	public @interface Usuarios {
		...
		@PreAuthorize("hasAuthority('ALTERAR_SENHA') and @oisolSecurity.getCodigoUsuario() == #codigoUsuario")
		@Retention(RUNTIME)
		@Target(METHOD)
		public @interface PodeAlterarSenha {
		}

		@PreAuthorize("hasAuthority('GERENCIAR_USUARIOS') or @oisolSecurity.getCodigoUsuario() == #codigoUsuario")
		@Retention(RUNTIME)
		@Target(METHOD)
