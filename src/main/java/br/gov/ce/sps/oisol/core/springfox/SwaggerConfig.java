package br.gov.ce.sps.oisol.core.springfox;

import br.gov.ce.sps.oisol.core.springfox.model.PageableModelSwagger;
import br.gov.ce.sps.oisol.domain.model.*;
...
public class SwaggerConfig {
	...
	public Docket productApi(){
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.gov.ce.sps.oisol.api"))
